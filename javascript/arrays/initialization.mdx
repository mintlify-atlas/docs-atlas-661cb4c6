---
title: Array Initialization in JavaScript
description: Learn the different ways to initialize JavaScript arrays and their performance implications
---
...
Oddly enough, this performance advantage still holds even if you chain an `Array.prototype.map()` call afterwards to create dynamic values.
